...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="<?=base_url()?>assets2/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="<?=base_url()?>login_admin" class="btn btn-default btn-lg">
                                    <i class="fa fa-pencil fa-fw"></i>
                                    <span class="network-name">Admin</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?=base_url()?>login_admin2" class="btn btn-default btn-lg">
                                    <i class="fa fa-user fa-fw"></i>
                                    <span class="network-name">User</span>
                                </a>
                            </li>

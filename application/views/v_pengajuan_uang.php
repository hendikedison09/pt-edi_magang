			...
			<table class="table table-bordered table-striped" id="example1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?= base_url('index.php/input/hapus_pengajuan/' . $pi->id_pengajuan) ?>" class="btn btn-danger btn-alert-hapus"
							onclick="return confirm('apakah anda yakin ?')">
								<i class="fas fa-trash-alt"></i>
							</a>
						</td>
						<td>
							<a href="" data-toggle="modal" data-target="#updateModal<?=$pi->id_pengajuan;?>" class="btn btn-outline-success">

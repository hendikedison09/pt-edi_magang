            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="transaksiSubmenu">
                        <li>
                            <a href="<?=base_url('input/det_transaksi')?>"> Laporan Kas Kecil</a>
                        </li>
                        <li>
                            <a href="<?=base_url('input/indexx')?>">Transaksi Pengeluaran Bank</a>
                        </li> 
                        <li>
                            <a href="<?=base_url('input/pengajuan')?>">Transaksi Pengajuan Uang Muka</a>
                        </li>
                        <li>
                            <a href="<?=base_url('input/pertanggungan')?>">Transaksi Pertanggungjawaban </a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="transaksiSubmenu">
                        <li>
                            <a href="<?=base_url('input/det_transaksi1')?>"> Laporan Kas Kecil</a>
                        </li>
                        <li>
                            <a href="<?=base_url('input/indexx1')?>">Transaksi Pengeluaran Bank</a>
                        </li> 
                        <li>
                            <a href="<?=base_url('input/pengajuan1')?>">Transaksi Pengajuan Uang Muka</a>
                        </li>
                        <li>
                            <a href="<?=base_url('input/pertanggungan1')?>">Transaksi Pertanggungjawaban </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?=base_url('input/log2')?>">
                        <span style="margin-right: 6px;"><i class="fas fa-key"></i></span> Log Activity
                    </a>
                </li>
                          <?php

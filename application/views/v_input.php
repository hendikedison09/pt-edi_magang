            ...
            <div class="body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#saldoModal">
                        ...
                        <table class="table table-bordered table-striped" id="example123" class="display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" data-toggle="modal" data-target="#updateModal<?=$di->id_input;?>">
      ...
      <div class="modal-body">
                ...
                <form id="form-tambah">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tanggal" aria-describedby="tanggal" placeholder="Enter tanggal">
                    </div>
                    <div class="form-group">

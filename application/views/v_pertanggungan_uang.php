			...
			<table class= "table table-bordered table-striped" id="" class="display">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="<?= base_url('index.php/input/hapus_pertanggungan/' .$pu->id_pertanggungan); ?>" class="btn btn-danger btn-alert-hapus"
							onclick="return confirm('apakah anda yakin ?')">
								<i class="fas fa-trash-alt"></i>
							</a>
						</td>
						<td>
							<a href="" data-toggle="modal" data-target="#updateModal<?=$pu->id_pertanggungan;?>" class="btn btn-outline-success">
